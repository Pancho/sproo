...
export class HttpGetAppTest extends AppTest {
	constructor() {
		super(
			'HTTP GET App Test',
			'Successfully got data from /app/test.json via a GET request',
			'Could not perform a GET request',
			FULL_APP_CONFIG,
		);
	}
...
export class RoutesAppTest extends AppTest {
	constructor() {
		super(
			'Routes App Test',
			'App set itself up and navigated successfully',
			'App failed to set up and navigate',
			ROUTES_APP_CONFIG,
		);
	}
...
export class OnAppReadyAppTest extends AppTest {
	constructor() {
		super(
			'On App Ready App Test',
			'onAppReady successfully fired',
			'onAppReady did not fire',
			FULL_APP_CONFIG,
		);
	}
